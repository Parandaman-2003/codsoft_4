...
public class QuizGame implements ActionListener {
    ...
    String[][] options = {   {"Sun Microsystems","Starbucks","Microsoft","Amazon"},
                             {"1989","1996","1972","1999"},
                             {"Apple","Latte","Oak","Camel"},
    ...
    public QuizGame(){
        ...
        time_label.setFont( new Font("MV Boli",Font.PLAIN,18));
        ...
        percentage.setFont( new Font("Ink Free",Font.BOLD,60));
